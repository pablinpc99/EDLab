...
public class L11_HashTable_EvalTest
{
    ...
    @Test
    public void testAddLinear() throws Exception
    {
    ...
    @Test
    public void testAddQuadratic() throws Exception
    {
    ...
    @Test
    public void testRemoveLinear() throws Exception
    {
        HashTable<Integer> a = new HashTable<Integer>(13, HashTable.LINEAR_PROBING, 1.0);
    ...
    @Test
    public void testRemoveQuadratic() throws Exception
    {
        HashTable<Integer> a = new HashTable<Integer>(13, HashTable.QUADRATIC_PROBING, 1.0);
    ...
    @Test
    public void testSearchLinear() throws Exception
    {
        HashTable<Integer> a = new HashTable<Integer>(13, HashTable.LINEAR_PROBING, 1.0);
    ...
    @Test
    public void testSearchQuadratic() throws Exception
    {
        HashTable<Integer> a = new HashTable<Integer>(13, HashTable.QUADRATIC_PROBING, 1.0);
